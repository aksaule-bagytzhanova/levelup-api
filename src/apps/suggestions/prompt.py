...
class ChatGPTProfileSportRequestTemplate:
    ...
    def generate_request(profile):
        prompt = f"Сделай мне список тренировок от фитнес инструктора:" \
                ...
                f"все должно быть на казахском языке кроме ключевых слов json." \
                f"Ответь строго в таком формате без других слов:" \
                "{'back': [{'title': 'тут название', 'description': 'тут детальное описание и пиши на разные линии'}],'hand': [{'title': 'тут название', 'description': 'тут детальное описаниеи пиши на разные линии'}], 'leg': [{'title': 'тут название', 'description': 'тут детальное описаниеи пиши на разные линии'}], 'chest': [{'title': 'тут название', 'description': 'тут детальное описаниеи пиши на разные линии'}], 'press': [{'title': 'тут название', 'description': 'тут детальное описаниеи пиши на разные линии'}]}"
